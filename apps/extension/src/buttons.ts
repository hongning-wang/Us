...
[data-us-action="reference"]{min-height:30px;padding:0 0 0 2px;margin:4px 0 0;border:0;border-radius:0;background:transparent;color:rgb(var(--ig-primary-text,0,0,0));font-size:12px;font-weight:600;letter-spacing:0}
...
[data-us-action="share"]{min-height:32px;width:auto;padding:0 12px;margin:0;border:1px solid rgb(var(--ig-separator,219,219,219));border-radius:8px;background:transparent;color:rgb(var(--ig-primary-text,0,0,0));font-size:14px;font-weight:600}
